...
if Server then
    ...
    function  makeDefaultConfig()
		...
		kLRconfig.kMaxRounds				 = 7 	 //Max Rounds Played per map ( 0 to limit by time )
		
        kLRconfig.kPregameLength             = 2     //Time before Tagmode (no crosshair)
        kLRconfig.kTagModeMaxLength          = 30    //After this time Server decides who will be alien
        kLRconfig.kRoundTimeLimit            = 360   //6min
        kLRconfig.kAftergameLength           = 7    //Time the scoreboard will show up until the next round starts
