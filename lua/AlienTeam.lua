...
function AlienTeam:InitTechTree()
    ...
    self.techTree:AddBuildNode(kTechId.CragHive,                kTechId.TwoHives,                kTechId.None)
    self.techTree:AddBuildNode(kTechId.ShadeHive,               kTechId.TwoHives,                kTechId.None)
    self.techTree:AddBuildNode(kTechId.ShiftHive,               kTechId.Hive,                kTechId.None)
    
    self.techTree:AddUpgradeNode(kTechId.UpgradeToCragHive,     kTechId.TwoHives,                kTechId.None)
    self.techTree:AddUpgradeNode(kTechId.UpgradeToShadeHive,    kTechId.TwoHives,                kTechId.None)
    ...
    self.techTree:AddUpgradeNode(kTechId.FadeEgg,          kTechId.None,                kTechId.None)
    ...
    self.techTree:AddBuildNode(kTechId.Shell, kTechId.None, kTechId.None)
    self.techTree:AddUpgradeNode(kTechId.UpgradeRegenerationShell, kTechId.None, kTechId.None)
    ...
    self.techTree:AddUpgradeNode(kTechId.UpgradeCarapaceShell, kTechId.None, kTechId.None)
    ...
    self.techTree:AddBuildNode(kTechId.Veil,                     kTechId.None,        kTechId.None)
    self.techTree:AddUpgradeNode(kTechId.UpgradeSilenceVeil,     kTechId.None,        kTechId.None)
    ...
    self.techTree:AddUpgradeNode(kTechId.UpgradeCamouflageVeil,  kTechId.None,        kTechId.None) 
    ...
    self.techTree:AddResearchNode(kTechId.Spores,            kTechId.None,              kTechId.None)
    ...
    self.techTree:AddBuyNode(kTechId.Camouflage, kTechId.None, kTechId.None, kTechId.AllAliens)
