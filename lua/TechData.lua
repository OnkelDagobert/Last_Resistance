...
function BuildTechData()
    ...
    local techData = { 
        ...
        { [kTechDataId] = kTechId.NanoShield,    [kTechDataCooldown] = kNanoShieldCooldown,      [kTechDataAllowStacking] = true, [kTechDataCollideWithWorldOnly] = false, [kTechDataMapName] = NanoShield.kMapName,   [kTechDataDisplayName] = "NANO_SHIELD_DEFENSE", [kTechDataCostKey] = kNanoShieldCost, [kTechDataTooltipInfo] = "NANO_SHIELD_DEFENSE_TOOLTIP"},        
        ...
        { [kTechDataId] = kTechId.Welder,     [kTechDataMaxHealth] = kWelderHealth, [kTechDataMaxArmor] = kWelderArmor, [kTechDataPointValue] = kWeaponPointValue, [kTechDataMapName] = Welder.kMapName,                    [kTechDataDisplayName] = "WELDER",      [kTechDataModel] = Welder.kModelName, [kTechDataDamageType] = kWelderDamageType, [kTechDataCostKey] = kWelderCost  },
        
        { [kTechDataId] = kTechId.Claw,      [kTechDataMapName] = Claw.kMapName, [kTechDataDisplayName] = "CLAW",  [kTechDataDamageType] = kClawDamageType },

        { [kTechDataId] = kTechId.Rifle,      [kTechDataMaxHealth] = kRifleHealth, [kTechDataMaxArmor] = kRifleArmor,  [kTechDataTooltipInfo] = "RIFLE_TOOLTIP", [kTechDataPointValue] = kWeaponPointValue,    [kTechDataMapName] = Rifle.kMapName,                    [kTechDataDisplayName] = "RIFLE",         [kTechDataModel] = Rifle.kModelName, [kTechDataDamageType] = kRifleDamageType, [kTechDataCostKey] = kRifleCost, },
        { [kTechDataId] = kTechId.Pistol,     [kTechDataMaxHealth] = kPistolHealth, [kTechDataMaxArmor] = kPistolArmor,  [kTechDataPointValue] = kWeaponPointValue,          [kTechDataMapName] = Pistol.kMapName,                   [kTechDataDisplayName] = "PISTOL",         [kTechDataModel] = Pistol.kModelName, [kTechDataDamageType] = kPistolDamageType, [kTechDataCostKey] = kPistolCost, [kTechDataTooltipInfo] = "PISTOL_TOOLTIP"},
        ...
        { [kTechDataId] = kTechId.Flamethrower,     [kTechDataMaxHealth] = kFlamethrowerHealth, [kTechDataMaxArmor] = kFlamethrowerArmor,   [kTechDataPointValue] = kWeaponPointValue,  [kTechDataMapName] = Flamethrower.kMapName,             [kTechDataDisplayName] = "FLAMETHROWER", [kTechDataTooltipInfo] = "FLAMETHROWER_TOOLTIP", [kTechDataModel] = Flamethrower.kModelName,  [kTechDataDamageType] = kFlamethrowerDamageType, [kTechDataCostKey] = kFlamethrowerCost, [kStructureAttachId] = kTechId.Armory, [kStructureAttachRange] = kArmoryWeaponAttachRange, [kStructureAttachRequiresPower] = true},
        { [kTechDataId] = kTechId.DualMinigunTech,       [kTechDataCostKey] = kDualMinigunTechResearchCost,      [kTechDataResearchTimeKey] = kDualMinigunTechResearchTime, [kTechDataDisplayName] = "RESEARCH_DUAL_MINIGUNS", [kTechDataHotkey] = Move.D, [kTechDataTooltipInfo] = "DUAL_MINIGUN_TECH_TOOLTIP"},
        { [kTechDataId] = kTechId.Minigun,               [kTechDataMapName] = Minigun.kMapName,                  [kTechDataDisplayName] = "MINIGUN", [kTechDataImplemented] = false,        [kTechDataDamageType] = kMinigunDamageType,         [kTechDataCostKey] = kMinigunCost, [kTechDataDisplayName] = "MINIGUN_CLAW_TOOLTIP", [kTechDataModel] = Minigun.kModelName},
        ...
        { [kTechDataId] = kTechId.LayBarricade,    [kTechDataMapName] = LayBarricade.kMapName,         [kTechDataHint] = "CLOG_HINT",		[kTechDataDisplayName] = "CLOG",   [kTechDataTooltipInfo] = "CLOG_HINT",		[kTechDataModel] = Clog.kModelName,      [kTechDataCostKey] = kMineCost },
        // Marine upgrades
        ...
        // tier 2
        { [kTechDataId] = kTechId.Leap,     [kTechDataRequiresMature] = false,      [kTechDataDisplayName] = "LEAP", [kTechDataCostKey] = kLeapResearchCost, [kTechDataResearchTimeKey] = kLeapResearchTime, [kTechDataTooltipInfo] = "LEAP_TOOLTIP" },     
        { [kTechDataId] = kTechId.BileBomb, [kTechDataRequiresMature] = false,             [kTechDataMapName] = BileBomb.kMapName,        [kTechDataDamageType] = kBileBombDamageType,  [kTechDataDisplayName] = "BILEBOMB", [kTechDataCostKey] = kBileBombResearchCost, [kTechDataResearchTimeKey] = kBileBombResearchTime, [kTechDataTooltipInfo] = "BILEBOMB_TOOLTIP" },
        { [kTechDataId] = kTechId.Spores,   [kTechDataRequiresMature] = false,             [kTechDataMapName] = Spores.kMapName,          [kTechDataDisplayName] = "SPORES", [kTechDataCostKey] = kSporesResearchCost, [kTechDataResearchTimeKey] = kSporesResearchTime, [kTechDataTooltipInfo] = "SPORES_TOOLTIP"},
        { [kTechDataId] = kTechId.Blink,    [kTechDataRequiresMature] = false,             [kTechDataDisplayName] = "BLINK", [kTechDataCostKey] = kBlinkResearchCost, [kTechDataResearchTimeKey] = kBlinkResearchTime, [kTechDataTooltipInfo] = "BLINK_TOOLTIP"},  
        { [kTechDataId] = kTechId.Stomp,    [kTechDataRequiresMature] = false,             [kTechDataDisplayName] = "STOMP", [kTechDataCostKey] = kStompResearchCost, [kTechDataResearchTimeKey] = kStompResearchTime, [kTechDataTooltipInfo] = "STOMP_TOOLTIP" }, 

        // tier 3
        { [kTechDataId] = kTechId.Xenocide,      [kTechDataRequiresMature] = false,     [kTechDataMapName] = XenocideLeap.kMapName,    [kTechDataDamageType] = kXenocideDamageType,   [kTechDataDisplayName] = "XENOCIDE", [kTechDataCostKey] = kXenocideResearchCost, [kTechDataResearchTimeKey] = kXenocideResearchTime, [kTechDataTooltipInfo] = "XENOCIDE_TOOLTIP"},
        { [kTechDataId] = kTechId.WebStalk ,     [kTechDataRequiresMature] = false,         [kTechDataMapName] = WebStalk.kMapName,        [kTechDataImplemented] = false, [kTechDataDisplayName] = "WEBSTALK", [kTechDataCostKey] = kWebStalkResearchCost, [kTechDataResearchTimeKey] = kWebStalkResearchTime, [kTechDataTooltipInfo] = "WEBSTALK_TOOLTIP"},
        { [kTechDataId] = kTechId.Umbra,         [kTechDataRequiresMature] = false,             [kTechDataMapName] = LerkUmbra.kMapName,       [kTechDataDisplayName] = "UMBRA", [kTechDataCostKey] = kUmbraResearchCost, [kTechDataResearchTimeKey] = kUmbraResearchTime, [kTechDataTooltipInfo] = "UMBRA_TOOLTIP"},
        { [kTechDataId] = kTechId.Vortex ,       [kTechDataRequiresMature] = false,         [kTechDataMapName] = Vortex.kMapName,   [kTechDataDisplayName] = "VORTEX", [kTechDataCostKey] = kVortexResearchCost, [kTechDataResearchTimeKey] = kVortexResearchTime, [kTechDataTooltipInfo] = "VORTEX_TOOLTIP"},
        //{ [kTechDataId] = kTechId.PrimalScream , [kTechDataRequiresMature] = false,        [kTechDataMapName] = PrimalScream.kMapName,       [kTechDataImplemented] = false, [kTechDataDisplayName] = "PRIMAL_SCREAM", [kTechDataCostKey] = kPrimalScreamResearchCost, [kTechDataResearchTimeKey] = kPrimalScreamResearchTime, [kTechDataTooltipInfo] = "PRIMAL_SCREAM_TOOLTIP"},
        ...
        { [kTechDataId] = kTechId.EvolveBabblers, [kTechDataRequiresMature] = true,  [kTechDataImplemented] = false,     [kTechDataDisplayName] = "EVOLVE_BABBLERS",  [kTechDataCostKey] = kEvolveBabblersCost, [kTechDataResearchTimeKey] = kEvolveBabblersResearchTime, [kTechDataTooltipInfo] = "EVOLVE_BABBLERS_TOOLTIP" },
        ...
        { [kTechDataId] = kTechId.CragBabblers,     [kTechDataImplemented] = false,     [kTechDataDisplayName] = "BABBLERS",   [kTechDataMapName] = CragBabblers.kMapName,    [kTechDataHotkey] = Move.B,                    [kTechDataCostKey] = kCragBabblersCost, [kTechDataTooltipInfo] = "BABBLERS_TOOLTIP" },
        ...
        // Lifeform purchases
        { [kTechDataId] = kTechId.Carapace,       [kTechDataCategory] = kTechId.CragHive,    [kTechDataDisplayName] = "CARAPACE",  [kTechDataCostKey] = kCarapaceCost, [kTechDataTooltipInfo] = "CARAPACE_TOOLTIP", },
        { [kTechDataId] = kTechId.Regeneration,   [kTechDataCategory] = kTechId.CragHive,    [kTechDataDisplayName] = "REGENERATION",  [kTechDataCostKey] = kRegenerationCost, [kTechDataTooltipInfo] = "REGENERATION_TOOLTIP", },
        { [kTechDataId] = kTechId.Silence,        [kTechDataCategory] = kTechId.ShadeHive,   [kTechDataDisplayName] = "SILENCE", [kTechDataTooltipInfo] = "SILENCE_TOOLTIP", [kTechDataCostKey] = kSilenceCost },
        { [kTechDataId] = kTechId.Camouflage,     [kTechDataCategory] = kTechId.ShadeHive,   [kTechDataDisplayName] = "CAMOUFLAGE", [kTechDataTooltipInfo] = "CAMOUFLAGE_TOOLTIP", [kTechDataCostKey] = kCamouflageCost },
        { [kTechDataId] = kTechId.Feint,          [kTechDataCategory] = kTechId.ShadeHive,   [kTechDataDisplayName] = "FEINT", [kTechDataTooltipInfo] = "FEINT_TOOLTIP", [kTechDataCostKey] = kFeintCost },
        
        { [kTechDataId] = kTechId.Celerity,       [kTechDataCategory] = kTechId.ShiftHive,   [kTechDataDisplayName] = "CELERITY", [kTechDataTooltipInfo] = "CELERITY_TOOLTIP", [kTechDataCostKey] = kCelerityCost },
        { [kTechDataId] = kTechId.Adrenaline,     [kTechDataCategory] = kTechId.ShiftHive,   [kTechDataDisplayName] = "ADRENALINE", [kTechDataTooltipInfo] = "ADRENALINE_TOOLTIP", [kTechDataCostKey] = kAdrenalineCost },
        { [kTechDataId] = kTechId.HyperMutation,  [kTechDataCategory] = kTechId.ShiftHive,   [kTechDataDisplayName] = "HYPERMUTATION", [kTechDataTooltipInfo] = "HYPERMUTATION_TOOLTIP", [kTechDataCostKey] = kHyperMutationCost },
        ...
        { [kTechDataId] = kTechId.NutrientMist, [kTechDataMapName] = NutrientMist.kMapName, [kTechDataAllowStacking] = true, [kTechDataCollideWithWorldOnly] = true, [kTechDataRequiresInfestation] = true, [kTechDataDisplayName] = "NUTRIENT_MIST", [kTechDataCostKey] = kNutrientMistCost, [kTechDataTooltipInfo] =  "NUTRIENT_MIST_TOOLTIP"},
        { [kTechDataId] = kTechId.BoneWall, [kTechDataGhostModelClass] = "AlienGhostModel", [kTechDataModel] = BoneWall.kModelName, [kTechDataMapName] = BoneWall.kMapName, [kTechDataOverrideCoordsMethod] = AlignBoneWalls, [kTechDataMaxHealth] = kBoneWallHealth, [kTechDataMaxArmor] = kBoneWallArmor,  [kTechDataPointValue] = kBoneWallPointValue, [kTechDataCooldown] = kBoneWallCooldown, [kTechDataCollideWithWorldOnly] = true, [kTechDataRequiresInfestation] = true, [kTechDataDisplayName] = "INFESTATION_SPIKE", [kTechDataCostKey] = kBoneWallCost, [kTechDataTooltipInfo] =  "INFESTATION_SPIKE_TOOLTIP"},
