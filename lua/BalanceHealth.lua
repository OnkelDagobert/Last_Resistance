...
// HEALTH AND ARMOR		
kMarineHealth = 100	kMarineArmor = 30	kMarinePointValue = 30
kJetpackHealth = 100	kJetpackArmor = 30	kJetpackPointValue = 70
kExosuitHealth = 100	kExosuitArmor = 400	kExosuitPointValue = 100
