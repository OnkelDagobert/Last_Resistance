...
function Player:GetWeaponClip()
    ...
    if weapon ~= nil then
        if weapon:isa("ClipWeapon") then
            ...
            //ISSUE 23:
        elseif weapon:isa("LayMines") or weapon:isa("LaySentry") or weapon:isa("LayBarricade") then
...
function Player:GetCountDownCamerStartCoords()  
    ...
    if #commandStructures > 0 then
        ...
        local randomSpawn = GetRandomSpawnForCapsule(extents.y, extents.x, commandStructures[1]:GetOrigin(), 4, 100, EntityFilterAll())
